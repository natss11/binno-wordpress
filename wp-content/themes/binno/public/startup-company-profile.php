...
get_header('profiles');
/*
Template Name: Startup Company Profile
*/
    ...
    <body class="bg-gray-100">
        <div class="container mx-auto p-8">
            ...
            <div class="flex items-center mb-5">
                <a href="<?php echo esc_url(home_url('startup-company')); ?>" class="blue-back text-lg">
            ...
            ?>
                <div class="container mx-auto p-15 px-36">
                    <div class="bg-white rounded-lg overflow-hidden shadow-md mb-5">
                        <img src="<?php echo esc_url($selected_company['setting_coverpic']); ?>" alt="<?php echo esc_html(str_replace('profile-cover-img/', '', $selected_company['setting_coverpic'])); ?>" class="w-full h-64 object-cover" style="background-color: #888888;">
                    </div>
                    <div class="flex -mt-20 ml-20">
                        <img src="<?php echo esc_url($selected_company['setting_profilepic']); ?>" alt="<?php echo esc_html(str_replace('profile-img/', '', $selected_company['setting_profilepic'])); ?>" class="w-32 h-32 object-cover rounded-full border-4 border-white" style="background-color: #888888;">
                ...
                <div class="flex container mx-auto p-15 px-36">
                    ...
                    <div class="w-3/4 p-4 flex flex-col gap-4">
                        ...
                        <div id="eventsContent" class="mt-10 ml-5">
                            ...
                            ?>
                                    <div class="border p-4 mb-4 mt-5">
                                        ...
                                        <img src="<?php echo isset($event['event_img']) ? esc_url($event['event_img']) : ''; ?>" alt="<?php echo isset($event['event_img']) ? esc_html($event['event_img']) : ''; ?>" class="w-full h-64 object-cover mb-2 mt-3" style="background-color: #888888;">
                        ...
                        <div id="postsContent" class="mt-10 ml-5" style="display: none;">
                            ...
                            $posts_url = "https://217.196.51.115/m/api/posts/";
                            $member_id = $selected_company['member_id'];
                            ...
                            ?>
                                        <div class="border p-4 mb-4 mt-5">
                                            ...
                                            <img src="<?php echo isset($post['post_img']) ? esc_url($post['post_img']) : ''; ?>" alt="<?php echo isset($post['post_img']) ? esc_html($post['post_img']) : ''; ?>" class="w-full h-64 object-cover mb-2 mt-3" style="background-color: #888888;">
